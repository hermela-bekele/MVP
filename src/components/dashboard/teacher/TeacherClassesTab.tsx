            ...
            <div key={a.id} className={`${aisCard} flex flex-col p-4`}>
              ...
              <div className={`${aisBodySm} space-y-2`}>
                <p className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-ais-on-surface">Room:</span> {a.room}
                </p>
                <p className="flex items-center gap-2">
                  <Clock className="h-3.5 w-3.5 shrink-0 text-ais-primary" aria-hidden />
                  <span className="font-semibold text-ais-on-surface">Period:</span> {a.period}
                </p>
                <p className="flex items-center gap-2">
                  <CalendarDays className="h-3.5 w-3.5 shrink-0 text-ais-primary" aria-hidden />
                  <span className="font-semibold text-ais-on-surface">Schedule:</span> {a.days}
                </p>
              </div>
              <div className="mt-4 flex items-end justify-between border-t border-ais-card-border pt-3">
                <div>
                  <span className={`${aisDataLg} text-ais-primary`}>{count}</span>
