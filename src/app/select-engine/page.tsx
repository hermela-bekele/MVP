...
import { ENGINE_DESCRIPTIONS, ENGINE_LABELS, enginesForRole, requiresEngineSelection, type EngineId } from '@/lib/engines';
          ...
          {engines.map((engine) => (
            ...
            >
              ...
              <div className="min-w-0">
                <p className="font-semibold text-foreground">{ENGINE_LABELS[engine]}</p>
