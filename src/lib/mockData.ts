...
/** National calendar generated by the MOE portal and disseminated to school heads. */
export interface MoeCalendarDraft {
  id: string;
  academicYear: string;
  title: string;
  events: AcademicCalendarEvent[];
...
export interface SchoolCheckIn {
  ...
  /** Absent entirely for anonymous responses — never stored, not just hidden. */
...
export type TrainingAudience = 'All' | 'Regional' | 'Woredas' | 'Schools';
